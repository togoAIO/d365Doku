...
> [!NOTE]
> Standardmäßig sind Sie auf 36 Spalten beschränkt, es sei denn, Sie erweitern die Budgetplanung, indem Sie die Schritte unter [Budgetplanungslayout erweitern (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/finance/budgeting/extending-budget-planning-layout) befolgen.
