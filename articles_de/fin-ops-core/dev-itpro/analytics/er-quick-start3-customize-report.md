...
Sie müssen die EB-Metadaten aktualisieren, um das von Ihnen hinzugefügte benutzerdefinierte Feld [sichtbar (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/analytics/electronic-reporting-er-configure-parameters) im EB Modellzuordnungsdesigner anzuzeigen.
