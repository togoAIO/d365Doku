...
Zum Entwickeln der neuen Logik müssen Sie eine Topologie bereitstellen, die einen fortlaufenden Build unterstützt . Weitere Informationen finden Sie unter [Bereitstellen von Topologien, die fortlaufenden Build und Testautomatisierung unterstützen (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/perf-test/continuous-build-test-automation) Sie unter. Sie müssen zudem Zugriff auf die Entwicklungsumgebung für diese Topologie haben. Weitere Informationen zur verfügbaren ER API finden Sie unter [EB-Framework-API (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/analytics/er-apis-app73).
...
> [!NOTE]
> Alternativ können Sie EB-Integrationspunkte verwenden, um EB-Formate zu filtern. Weitere Informationen finden Sie unter [API zum Anzeigen einer Formatzuordnungssuche (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/analytics/er-apis-app10-0-11).
...
> [!NOTE]
> In einer neuen Umgebung müssen Sie möglicherweise die EB-Metadaten aktualisieren, damit dieser Klassentyp im EB-Modellzuordnungsdesigner verfügbar ist. Weitere Informationen finden Sie unter [Konfigurieren des EB-Frameworks (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/analytics/electronic-reporting-er-configure-parameters).
...
- [ER-Framework-API (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/analytics/er-apis-app73)
