...
Die Daten-API für Human Resources ist eine OData-Implementierung. Weitere Informationen finden Sie unter [Open Data Protocol (OData) (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/odata).
...
Wie Sie ein Zugriffstoken zum Aufrufen der Daten-API für Human Resources abrufen, hängt von den Technologien ab, die Sie zum Entwickeln Ihrer Clientanwendung verwenden. Mögliche Beispiele sind die [Durchführung von Tests mit einem Drittanbieter-Hilfsprogramm (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/third-party-service-test) (z. B. Postman), die Entwicklung von C#-Konsolenanwendungen oder -Webdiensten oder die Erstellung eines JavaScript/TypeScript-Clients.
