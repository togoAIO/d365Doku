...
Microsoft Dynamics 365 Supply Chain Management 10.0.6 enthält das Plattform-Update 30. Weitere Informationen zum Plattform-Update 30 finden Sie unter [Was ist neu oder geändert in Platform Update 30 (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/fin-ops/get-started/whats-new-platform-update-30).
