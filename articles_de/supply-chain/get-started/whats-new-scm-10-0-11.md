...
Microsoft Dynamics 365 Supply Chain Management 10.0.11 enthält das Plattform-Update. Weitere Informationen finden Sie unter [Plattform-Updates für Version 10.0.11 von Finance and Operations Apps (Juli 2020) (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35).
