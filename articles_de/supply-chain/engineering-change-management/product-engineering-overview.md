...
1. Legen Sie Ihr System in den Wartungsmodus ein, wie in [Wartungsmodus (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/sysadmin/maintenance-mode) beschrieben.
...
1. Schalten Sie den Wartungsmodus aus, wie in [Wartungsmodus (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/sysadmin/maintenance-mode) beschrieben.
