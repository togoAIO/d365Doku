...
Verwenden Sie eine externe (öffentliche) Zertifizierungsstelle (CA). Ein Fix für dieses Problem ist in Version 1.9.0.0 der Lagerort App verfügbar. Weitere Informationen zu diesem Problem und wie Sie es beheben können, finden Sie unter [Fehlerbehebung bei Verbindungsproblemen der Lagerort App (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/supply-chain/warehousing/troubleshoot-warehouse-app-connection).
