...
> [!NOTE]
> Wenn Sie ein System einrichten möchten, das Demodaten zum Testen von Anlagenverwaltung-Funktionen enthält, finden Sie unter [Demoumgebung bereitstellen (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/fin-ops-core/dev-itpro/deployment/deploy-demo-environment) Anweisungen.
