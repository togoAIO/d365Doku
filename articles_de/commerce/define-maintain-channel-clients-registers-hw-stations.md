...
> [!NOTE]
> Spezifische Installationsanweisungen finden Sie unter [Konfigurieren und richten Sie Retail hardware station (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/commerce/retail-hardware-station-configuration-installation) und unter [Konfigurieren, Installieren und Aktivieren von Modern POS (MPOS) (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/commerce/retail-modern-pos-device-activation).
