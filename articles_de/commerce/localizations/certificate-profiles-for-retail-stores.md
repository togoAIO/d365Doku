...
Dieses Thema bietet einen Überblick über die Zertifikatprofile, die in Microsoft Dynamics 365 Commerce verfügbar sind. Diese Funktionalität erweitert die Funktion [Geheimnisse für Einzelhandelskanäle verwalten (This is an external link)](https://docs.microsoft.com/de-de/dynamics365/supply-chain/commerce/dev-itpro/manage-secrets) um den Support für lokale Zertifikate.
