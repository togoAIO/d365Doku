...
3. [Bootstrap (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/dual-write/bootstrap-company-data) the Dataverse data by using a three-letter International Organization for Standardization (ISO) company code.
...
1. Create a new company in the Finance and Operations app.
2. Add the company to the dual-write connection setup.
3. [Bootstrap (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/dual-write/bootstrap-company-data) the Dataverse data by using a three-letter ISO company code.
4. Run the **Initial sync** functionality for the tables that you want to sync data for.
...
1. [Set up the connection from the Finance and Operations app (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/dual-write/enable-dual-write).
2. Run the **Initial sync** functionality for the tables that you want to sync data for.
...
1. [Set up the connection from the Finance and Operations app (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/dual-write/enable-dual-write).
2. To sync the existing Dataverse data to the Finance and Operations app, [bootstrap (This is an external linThis link was changed due to HTMLfromRepoGenerator)](bootstrap (This is an external linThis link was changed due to HTMLfromRepoGenerator)-company-data.md) the Dataverse data by using a three-letter ISO company code.
...
For an example, see [Enabling the Customers V3—Contacts table map (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/data-entities/dual-write/enable-entity-map)
