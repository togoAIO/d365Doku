...
For more options to implement B2B users, see [Export B2B users to Azure AD (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/sysadmin/implement-b2b).

For information about preconfigured system accounts, see [Preconfigured system accounts (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/en-us/dynamics365/supply-chain/fin-ops-core/dev-itpro/sysadmin/pre-configured-system-accounts)
