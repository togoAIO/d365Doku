...
| Site | Description |
|------|-------------|
| [Docs.microsoft.com (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/dynamics365/) | This site hosts or links to all product documentation for Dynamics 365. |
...
| [Docs.microsoft.com/previous versions (This is an external linThis link was changed due to HTMLfromRepoGenerator)](https://docs.wika.com/previous-versions/dynamics/) | This site hosts content from previous releases. |
